...
![Phase](https://img.shields.io/badge/roadmap-Phase%202-F25C05)
...
| フェーズ | ゴール | 状態 |
|---------|--------|:---:|
| **Phase 1: 基盤構築** | フォルダ構成・経営文書・AI社員6名の定義を完了 | ✅ |
| **Phase 2: 制作エンジン稼働** | プロンプト集・Webテンプレート整備(完了)、自社メディア運用・自動化第1弾(進行中) | 🔄 |
| **Phase 3: 収益化・受注** | サービスメニュー策定、初回案件の受注・納品、継続クライアント3社 | ⏳ |
| **Phase 4: プロダクト化** | 会社OSテンプレート・プロンプト集・教材の商品化、受託とプロダクト収入の複線化 | ⏳ |

詳細なチェックリストは [`00_COMPANY/Roadmap.md`](00_COMPANY/Roadmap.md) で管理しています(四半期ごとに見直し)。
